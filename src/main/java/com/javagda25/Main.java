...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("*********************");
        sklepKomputerowy.wypiszKomputeryOMocyWyzszejNiz(270);
        System.out.println("*********************");
        ...
        System.out.println("*********************");
        sklepKomputerowy.zwrocWszystkieKomputeryZDwomaProcesorami();
        System.out.println("*********************");
        sklepKomputerowy.zwrocSredniaIloscProceosorow();
        System.out.println("*********************");
        sklepKomputerowy.zwróćTylkoKomputeryZTurboIWiecejNiz4Procesorami();
        System.out.println("*********************");
        sklepKomputerowy.zwrocKomputerONajwyzszejPobieranejMocy();
        System.out.println("*********************");
        sklepKomputerowy.zwrocKomputerONajnizszejPobieranejMocy();
        System.out.println("*********************");
        sklepKomputerowy.zwrocKomputeryKtoreMajaTurboIDwaProcesory();
    }
}
